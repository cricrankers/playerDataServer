...
async function dataWriter(yearStats) {
    fs.writeFileSync('combinedYearT20WcStats.json', JSON.stringify(yearStats, null, 2));
}
...
async function urlGenerator() {
    ...
    url[0] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=11;template=results;trophy=89;type=aggregate`;
    url[1] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=1;template=results;trophy=89;type=aggregate`;
    url[2] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;template=results;trophy=89;type=aggregate`;
    url[3] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;template=results;trophy=89;type=aggregate`;
