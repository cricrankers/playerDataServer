...
async function dataWriter(yearStats) {
    fs.writeFileSync('countryStats.json', JSON.stringify(yearStats, null, 2));
...
async function urlGenerator(year, team) {
    ...
    return [
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=11;host=${teamId};spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;type=aggregate`,
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=1;host=${teamId};spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;type=aggregate`,
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;host=${teamId};spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;type=aggregate`,
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;host=${teamId};spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;;type=aggregate`
    ];
}
...
async function main() {
    ...
    for (let team of teams) {
        ...
        for (let year = 1900; year < 2025; year++) {
            ...
            console.log(`Processed data for team: ${team}, year: ${year}`);
        }
