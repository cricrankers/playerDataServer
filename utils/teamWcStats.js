...
async function dataWriter(yearStats) {
    fs.writeFileSync('teamWcStats.json', JSON.stringify(yearStats, null, 2));
...
async function urlGenerator(year, team) {
    ...
    return [
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=11;spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;team=${teamId};template=results;trophy=12;type=team`,
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=1;spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;team=${teamId};template=results;trophy=12;type=team`,
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;team=${teamId};template=results;trophy=12;type=team`,
        `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;spanmax2=31+dec+${year};spanmin2=01+Jan+${year};spanval2=span;team=${teamId};template=results;trophy=12;type=team`
    ];
}
