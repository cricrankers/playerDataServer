...
async function dataWriter(yearStats) {
    fs.writeFileSync('yearWcStats.json', JSON.stringify(yearStats, null, 2));
}
...
async function urlGenerator(year) {
    ...
    url[0] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=11;spanmax2=31+Dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;trophy=12;type=aggregate`;
    url[1] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=1;spanmax2=31+Dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;trophy=12;type=aggregate`;
    url[2] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;spanmax2=31+Dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;trophy=12;type=aggregate`;
    url[3] = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;spanmax2=31+Dec+${year};spanmin2=01+Jan+${year};spanval2=span;template=results;trophy=12;type=aggregate`;
